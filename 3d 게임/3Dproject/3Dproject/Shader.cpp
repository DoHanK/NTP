...
{
	return(CShader::CompileShaderFromFile((WCHAR*)L"Shaders.hlsl", "VSBoundingBox", "vs_5_1", &m_pd3dVertexShaderBlob));
}

D3D12_SHADER_BYTECODE CBoundingBoxShader::CreatePixelShader()
{
	return(CShader::CompileShaderFromFile((WCHAR*)L"Shaders.hlsl", "PSBoundingBox", "ps_5_1", &m_pd3dVertexShaderBlob));
}
...
void CUIShader::CreateShader(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, ID3D12RootSignature* pd3dGraphicsRootSignature, D3D12_PRIMITIVE_TOPOLOGY_TYPE d3dPrimitiveTopologyType)
{
	//CShader::CreateShader(pd3dDevice, pd3dCommandList, pd3dGraphicsRootSignature);
...
{
	return(CShader::CompileShaderFromFile((WCHAR*)L"Shaders.hlsl", "VSUiRect", "vs_5_1", &m_pd3dVertexShaderBlob));
}

D3D12_SHADER_BYTECODE CUIShader::CreatePixelShader()
{
	return(CShader::CompileShaderFromFile((WCHAR*)L"Shaders.hlsl", "PSUiRect", "ps_5_1", &m_pd3dVertexShaderBlob));
}
