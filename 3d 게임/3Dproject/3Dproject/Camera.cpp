...
void CCamera::CreateShaderVariavles(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList) {
...
void CCamera::UpdateShaderVariavles(ID3D12GraphicsCommandList* pd3dCommandList) {
...
void CCamera::ReleaseShaderVariavles() {}
